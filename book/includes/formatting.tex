...
\newcommand{\fixthmbox}{\setlist[itemize,enumerate]{topsep={5pt},leftmargin=*}\setlength{\parskip}{7pt}\vspace{0pt}}
...
\definecolor{green1}{HTML}{F9FFF9}
\definecolor{green2}{HTML}{82B366}