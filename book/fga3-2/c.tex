...
if $S=\operatorname{Spec}(\Lambda)$, then $\mathcal{C}_0$ is the category dual to the category of Artinian $\operatorname{\Gamma}$-algebras considered in \Cref{fga3.ii-b}.
